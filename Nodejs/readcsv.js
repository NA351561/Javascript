		...
		function oilseeds()
		{
			...
			for(var i=25;i<readdata.length;i=i+26) //iterating to get all the first column values
			{
				...
				if(s>0)
				{
					...
					oilobj[readdata[0]]=readdata[i];
					oilobj['3-2013']=Number(temp); //store key value pair
		...
		function foodgrains()
		{
			...
			for(var i=25;i<readdata.length;i=i+26)  //iterating to get all the data of name of foodgrains
			{
				...
				if(s1==1&&s2==0&&s3==0&&s4==0&&s5==1)
				{
					...
					foodobj[readdata[0]]=readdata[i];
					foodobj['3-2013']=Number(temp); //storing read values as key value pair
